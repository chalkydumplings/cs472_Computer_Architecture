...
\lstinputlisting{../block_move/block_move.s}
...
\lstinputlisting{../quad_func/quad_func.s}
...
\lstinputlisting{../avg_vec/avg_vec.s}
...
\lstinputlisting{../flip_endianness/flip_endianness.asm}
