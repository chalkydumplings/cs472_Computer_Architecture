...
\begin{mdframed}[style=MyFrame]
Unix is simple and many commands can be strung together kinda like how RISC is taking multiple instructions and performing them. RISC has fewer instructions then CISC but the instructions that it does have are compilations of CISC instructions that will execute in multiple clock cycles. 
\end{mdframed}
